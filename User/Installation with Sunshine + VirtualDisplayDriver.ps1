...
# Install Sunshine
(New-Object System.Net.WebClient).DownloadFile("https://github.com/LizardByte/Sunshine/releases/download/v2025.122.141614/sunshine-windows-installer.exe", "C:\Users\$env:USERNAME\Downloads\sunshine-windows-installer.exe")
...
# Function for AutoActiveMS
Function AutoActiveMSFN {
    $XML = @"
<?xml version="1.0" encoding="UTF-16"?>
<Task version="1.2" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  <RegistrationInfo>
    <Description>Auto Active MS Task</Description>
    <URI>\AutoActiveMS</URI>
  </RegistrationInfo>
  <Triggers>
    <LogonTrigger>
      <Enabled>true</Enabled>
  ...
  <Actions Context="Author">
    <Exec>
      <Command>C:\WINDOWS\system32\WindowsPowerShell\v1.0\powershell.exe</Command>
      <Arguments>-file %programdata%\Easy-GPU-P\AutoActive.ps1</Arguments>
    </Exec>
  </Actions>
</Task>
"@
    ...
    try {
        Get-ScheduledTask -TaskName "AutoActiveMS" -ErrorAction Stop | Out-Null
        Unregister-ScheduledTask -TaskName "AutoActiveMS" -Confirm:$false
    } catch {}
    $action = New-ScheduledTaskAction -Execute 'C:\WINDOWS\system32\WindowsPowerShell\v1.0\powershell.exe' -Argument '-file %programdata%\Easy-GPU-P\AutoActive.ps1'
    $trigger =  New-ScheduledTaskTrigger -AtStartup
    Register-ScheduledTask -XML $XML -TaskName "AutoActiveMS" | Out-Null
    }
...
Start-ScheduledTask -TaskName "AutoActiveMS"
